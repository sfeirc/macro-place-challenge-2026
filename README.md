...
[Reevaluating Google's Reinforcement Learning for IC Macro Placement](https://cacm.acm.org/research/reevaluating-googles-reinforcement-learning-for-ic-macro-placement/)
...
| 3 | "ByteDancer" (Incremental CD) | **1.4156** | — | — | 0 | 42min/bench | |
| 4 | "BakaBobo" (Spread+Refine) | **1.4403** | — | — | 0 | 212s/bench | |
| 5 | "Convex Optimization" (UWaterloo Student) | **1.4556** | — | — | 0 | 16s total | |
...
| 11 | "Cezar" (CRISP) | **1.5806** | — | — | 0 | 10min/bench | |
